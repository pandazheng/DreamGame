...
#ifndef __tribewar__MenuBaseLayer__
#define __tribewar__MenuBaseLayer__
...
{
public:
    CCB_STATIC_NEW_AUTORELEASE_OBJECT_WITH_INIT_METHOD(MenuBaseLayer, create);
...
#endif /* defined(__tribewar__MenuBaseLayer__) */
